...
/* JavaScript content from lib/openfb.js in folder common */
/**
...
var openFB = (function () {
    ...
    var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth',
        ...
        //oauthcallback.html when placed in MobileFirst, it is kept in a relative location. Add its relative path after 'context'.
        baseURL = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + context + '/apps/services/preview/Conference/common/0/default',
